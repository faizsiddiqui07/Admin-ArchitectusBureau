...
const CreateProject = () => {
  ...
  const [openUploadProject, setOpenUploadProject] = useState(true);
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      const response = await axios.post(`${base_url}/api/add-project`, data, {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden transform transition-all">
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100">
              <div>
                <h2 className="text-xl xs:text-2xl font-bold text-gray-900">Create New Project</h2>
                <p className="text-gray-600 text-[12px] xxs:text-sm mt-1">Add a new project to your portfolio</p>
              </div>
              <button
                onClick={() => {
                  setOpenUploadProject(false);
            ...
            >
              ...
              <div className="mb-6">
                ...
                <label htmlFor="uploadImageInput" className="block cursor-pointer">
                  <div className={`border-2 border-dashed border-gray-300 rounded-2xl p-8 text-center transition-all duration-200 hover:border-amber-400 hover:bg-amber-50 group ${
                ...
                {data.projectImage.length > 0 && (
                  <div className="mt-4">
                    <p className="text-sm font-medium text-gray-700 mb-3">
                      Uploaded Images ({data.projectImage.length})
                    </p>
